...
{/*         <div>
          <img src="./img/logo-devansh-light.gif" alt="Logoipsum" />
        </div> */}
        ...
        <div className="footer--social--icon">
          <ul>
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/devansh-dalwadi-7008aa276/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💕 by Devansh 🥸</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
